import{L as e,S as t,R as s,l as a,a as i,b as c,h as r,P as o,C as n,c as d,d as l,p as v,e as m}from"./index.88c2ba31.js";import"./vendor.1d43dcfd.js";var p=Object.defineProperty,u=Object.getOwnPropertyDescriptor,h=(e,t,s,a)=>{for(var i,c=a>1?void 0:a?u(t,s):t,r=e.length-1;r>=0;r--)(i=e[r])&&(c=(a?i(t,s,c):i(c))||c);return a&&c&&p(t,s,c),c};let b=class extends e{constructor(){super(...arguments),this.recuperationCommunesEnCours=!1,this.statsLieu=void 0}async onSearch(e){const r="standard";if(t.isByDepartement(e.detail)){const t=e.detail.departement;s.navigateToRendezVousAvecDepartement(t.code_departement,a(t),r)}else{const t=e.detail.commune,o=(await i.current.departementsDisponibles()).find((({code_departement:e})=>e===t.codeDepartement));if(!o)return void console.error(`Can't find departement matching code ${t.codeDepartement}`);s.navigateToRendezVousAvecCommune("distance",o.code_departement,a(o),t.code,t.codePostal,c(t),r)}}render(){return r`
